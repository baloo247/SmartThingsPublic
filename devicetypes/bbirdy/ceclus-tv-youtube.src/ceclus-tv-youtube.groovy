...
metadata {
  definition (name: "Ceclus TV Youtube", namespace: "BBirdy", author: "Bal Birdy") {
    capability "Switch"
...
tiles(scale:2) {
 ...
 def on() {
	def result = new physicalgraph.device.HubAction(
            ...
            body: ("""<?xml version="1.0" ?><browserseturl><load url='http://www.youtube.com/tv'/></browserseturl>"""),
            headers: ["Content-Type":"text/plain"+" ; "+"charset=ISO-8859-1",Host:"${ipadd}:${smartapp_port}"]
    )
    log.debug state.tv_ip.toString()
