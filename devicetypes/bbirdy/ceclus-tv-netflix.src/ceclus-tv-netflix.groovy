...
metadata {
  definition (name: "Ceclus TV Netflix", namespace: "BBirdy", author: "Bal Birdy") {
    capability "Switch"
...
tiles(scale:2) {
 ...
 def on() {
	def result = new physicalgraph.device.HubAction(
            ...
            body: ("""<?xml version="1.0" ?><browserseturl><load url='http://www.portaltv.tv/swf/netflix/netflix.swf'/></browserseturl>"""),
